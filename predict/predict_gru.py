...
Loads the trained GRU model and predicts
    ...
    def predict(
        ...
        if isinstance(
            ...
            if len(features) != 1:
                ...
                raise ValueError(
                    "GRU predictor accepts "
                    "one sample at a time."
                )

            # Preserve scaler feature order.
...
if __name__ == "__main__":
    ...
    try:
        ...
        print()
        print(
            "GRU predictor test completed successfully."
        )
